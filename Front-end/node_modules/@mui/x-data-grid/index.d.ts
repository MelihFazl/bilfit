 ...
 * The full grid API.
 */
export declare type GridApi = GridApiCommunity;
/**
 * The state of `DataGrid`.
 */
export declare type GridState = GridStateCommunity;
/**
 * The initial state of `DataGrid`.
 */
export declare type GridInitialState = GridInitialStateCommunity;
/**
